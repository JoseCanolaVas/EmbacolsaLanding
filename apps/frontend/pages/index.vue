<template>
  <v-app class="storefront" :style="variablesMarca">
    ...
    <!-- AVISO PERMANENTE DE SUSPENSIÓN -->
    <v-snackbar
      v-model="avisoSuspension"
      :timeout="-1"
      top
      centered
      color="warning"
      elevation="24"
      class="aviso-suspension"
    >
      <div class="d-flex align-center">
        ...
        <strong>
          AVISO IMPORTANTE: este sitio web será desactivado el
          19 de agosto de 2026 a las 12:00 p. m.
        </strong>
      </div>
    </v-snackbar>
      ...
      <section id="inicio" class="hero-section">
        ...
        <v-container class="hero-inner">
          ...
          <div class="hero-copy">
            ...
            <p>
              {{ 'contacta a softnova para poder activar tu servicio' }}
            </p>
          ...
          <div
            v-if="bannerActual"
            class="hero-products-figure"
          >
            <img
              :src="bannerActual"
              alt="Banner Embacolsa"
            >
      ...
      <section id="productos" class="products-section">
        ...
        <v-container>
          ...
          <div class="section-heading products-heading">
            ...
            <div>
              ...
              <span class="eyebrow blue">
                {{ configuracionSitio.subtitulo_productos }}
              </span>
              ...
              <p class="section-lead">
                Productos reales del panel, organizados para vender sin enredos.
              </p>
          ...
          <v-row>
            ...
            <v-col
              v-for="product in productosIndex"
              :key="product.title"
              cols="12"
              sm="6"
              lg="3"
            ...
            >
              ...
              <div class="empty-products">
                ...
                <p>
                  Prueba con otra categoria o limpia la busqueda.
                </p>
        ...
        <v-container>
          ...
          <v-row align="center">
            ...
            >
              ...
              <span>
                OPERACIÓN SIN ENREDOS
              </span>

              <h2>
                {{ configuracionSitio.titulo_beneficios }}
              </h2>

              <p>
                {{ configuracionSitio.descripcion_beneficios }}
              </p>
            ...
            >
              ...
              <div class="benefit-grid">
                ...
                <div
                  v-for="benefit in benefitsActuales"
                  :key="benefit.title"
                  class="benefit-item"
                >
      ...
      >
        ...
        <v-container class="contact-inner">
          ...
          <div>
            ...
            <h2>
              {{ configuracionSitio.titulo_contacto }}
            </h2>

            <p>
              {{ configuracionSitio.descripcion_contacto }}
            </p>
    ...
    <footer class="store-footer">
      ...
      <v-container class="footer-inner">
        ...
        <span>
          ...
          {{ configuracionSitio.nombre_sitio }}
        </span>
...
export default {
  ...
  computed: {
    ...
    logoActual() {
      ...
      return this.obtenerImagenPorTipo('logo') ||
    ...
    categoriasIndex() {
      ...
      const categoriasActivas = this.categoriasParametrizadas
        ...
        .filter(categoria =>
          this.estaActivo(categoria.estado)
        )
    ...
    productosIndex() {
      ...
      const productosActivos =
        this.productosParametrizados
          ...
          .filter(producto =>
            this.estaActivo(producto.estado)
          )
          ...
          .map((producto, index) => ({
            ...
            icon:
              this.obtenerIconoProducto(producto),

            class:
              this.obtenerClaseVisual(index),
    ...
    variablesMarca() {
      ...
      return {
        ...
        '--brand-primary':
          this.coloresMarca.primario,

        '--brand-secondary':
          this.coloresMarca.secundario,

        '--brand-accent':
          this.coloresMarca.acento,

        '--brand-bg':
          this.coloresMarca.fondo,
    ...
    whatsappUrl() {
      ...
      const telefono =
        this.configuracionSitio.telefono_whatsapp ||
        '573218720375'


      const mensaje =
        `Hola, quiero cotizar productos de ${
          this.configuracionSitio.nombre_sitio ||
          'Embacolsa'
        }`
    ...
    correoUrl() {
      ...
      return `mailto:${
        this.configuracionSitio.correo_contacto ||
        'comercial@embacolsa.com.co'
      }`
  ...
  methods: {
    ...
    obtenerImagenPorTipo(tipoBuscado) {
      ...
      const imagen =
        this.imagenesParametrizadas.find(
          (item) => {
